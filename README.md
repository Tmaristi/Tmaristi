...
Estudiante de Ingeniería de Sistemas e Informática en la **Universidad Nacional de Colombia** (Facultad de Minas, Medellín). Trabajo actualmente como auxiliar en un proyecto de plataforma de evaluación docente, y me interesa el desarrollo full-stack, la nube, la seguridad y los agentes de IA.

- 🎓 Estudiando Ing. de Sistemas e Informática — U. Nacional, Medellín.
- 💼 Auxiliar en proyecto de Evaluación Formativa de la Docencia Universitaria.
- 🤖 Construyendo agentes de IA con function calling y RAG.
- 🌱 Aprendiendo constantemente sobre cloud (AWS/GCP).
- 🐧 Uso Linux (Fedora KDE) como entorno principal de desarrollo.
...
- LinkedIn: [Tomas Murillo Aristizabal](https://www.linkedin.com/in/tomas-murillo-aristizabal-9a6a46303)
